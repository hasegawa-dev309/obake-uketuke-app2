...
export const MobileComplete: React.FC = () => {
  ...
  return (
    <MobileLayout title="予約完了" showBackButton={false}>
      <div className="text-center space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={handleShare}
            className="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-xl border-2 border-gray-200 shadow-sm transition-all duration-200 transform hover:scale-105 active:scale-95"
          >
            <div className="flex items-center justify-center space-x-3">
